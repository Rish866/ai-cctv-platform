...
const RULE_TYPES = [
  ...
  // Safety & Security add-on types.
  'FIRE', 'SMOKE', 'FIRE_AND_SMOKE',
  'UNAUTHORIZED_ENTRY', 'AFTER_HOURS_ACTIVITY', 'OBJECT_REMOVED',
  'LOITERING_SECURITY', 'UNAUTHORIZED_VEHICLE', 'RESTRICTED_ZONE_ACTIVITY',
];
